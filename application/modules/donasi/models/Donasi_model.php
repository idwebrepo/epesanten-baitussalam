...
class Donasi_model extends CI_Model
{
    ...
    function get($params = array())
    {
        ...
        $this->db->select('program_id, program_name, program_description,program_realisasi, program_end,
        program_target,program_earn, program_gambar, program_status, account_account_id, pendayagunaan_account_id,
        majors_id,
        account_id as account_id, account_code as account_code, account_description as account_description');
