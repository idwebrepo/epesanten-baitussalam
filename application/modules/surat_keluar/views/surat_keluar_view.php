	...
	<section class="content">
		...
		<div class="row">
			<div class="col-md-12">
					...
					<div class="box-body">
						<div class="col-md-12 col-sm-12 col-xs-12 pull-left">
							...
							<div class="row">
									...
									<table class="table table-hover">
										<tbody>
											...
											<tr>
												<td>Isi Surat</td>
												<td>:</td>
												<td><?php echo $surat_keluar['isi'] ?></td>
											</tr>
											<tr>
												<td>Tanggal Surat</td>
												<td>:</td>
								...
								<div class="col-md-4">
									<a href="<?php echo site_url('manage/surat_keluar') ?>" class="btn btn-default">
										<i class="fa fa-arrow-circle-o-left"></i> Kembali
									</a>
									<?php if ($this->session->userdata('uroleid') == SUPERUSER) { ?>
									<a href="<?php echo site_url('manage/surat_keluar/edit/' . $surat_keluar['id_surat']) ?>" class="btn btn-success">
										<i class="fa fa-edit"></i> Edit
									</a>
									<a href="#delModal<?php echo $surat_keluar['id_surat']; ?>" data-toggle="modal" class="btn btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Hapus"></i> Hapus</a>
									<?php } ?>
								</div>
							</div>
							<!-- /.box-body -->
				...
				<!-- /.row -->
				<div class="modal modal-default fade" id="delModal<?php echo $surat_keluar['id_surat']; ?>">
						...
						<div class="modal-content">
							<div class="modal-header">
								...
								<div class="modal-footer">
									<?php echo form_open('manage/surat_keluar/delete/' . $surat_keluar['id_surat']); ?>
