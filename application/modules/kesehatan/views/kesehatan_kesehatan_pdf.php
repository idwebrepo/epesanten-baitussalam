...
<head>
	<title>Surat Keterangan Sakit <?php foreach ($kesehatan as $row) : ?><?php echo $row['student_full_name'] ?><?php endforeach ?></title>
</head>
		...
		<tbody>
			...
			<tr>
				<td colspan="4" align="center"><b><u>
							<center>
								<font size="18px">SURAT KETERANGAN SAKIT</font>
						</u></b></center>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style="width: 100px;">Kelas Pondok</td>
				<td style="width: 5px;">:</td>
				<?php foreach ($kesehatan as $row) : ?>
			...
			<tr>
				...
				<td style="width: 5px;">:</td>
				<?php foreach ($kesehatan as $row) : ?>
					<td colspan="2"><?php echo $row['kesehatan_note'] ?></td>
				<?php endforeach ?>
			</tr>
			<tr>
			...
			<tr>
				<td colsapn="4" style="height: 50px;">&nbsp;</td>
			</tr>
			<tr>
				<td colspan="3" style="text-align: center;"></td>
