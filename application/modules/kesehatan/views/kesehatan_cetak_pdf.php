...
<head>
	<title>Buku Riwayat Sakit<?php foreach ($siswa as $row): ?> <?php echo ($f['r'] == $row['student_nis']) ? $row['student_full_name'] : '' ?><?php endforeach; ?></title>
</head>
...
<body>
	...
	<table style="border-style: solid;">
		<tr>
			...
			<th style="border-top: 1px solid; border-bottom: 1px solid;">Obat yang Diberikan</th>
