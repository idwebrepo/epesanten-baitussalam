	...
	<div class="container">
		<div class="topright">
			...
			if ($num > 1) { ?>
				...
				$path = 'media/barcode_transaction/' . $bcode['kas_noref'] . '.png';
				$type = pathinfo($path, PATHINFO_EXTENSION);
				$data = file_get_contents($path, false, stream_context_create($arrContextOptions));
				$base64 = 'data:image/' . $type . ';base64,' . base64_encode($data);
				?>
				<img style="width:100.5pt;height:15pt;z-index:6;" src="<?php echo $base64 ?>" alt="Image_4_0" /><br>
	...
	<table>
		<tr>
			<td width="6%">
				...
				$path = upload_url('school/' . logo());
				$type = pathinfo($path, PATHINFO_EXTENSION);
				$data = file_get_contents($path, false, stream_context_create($arrContextOptions));
				$base64 = 'data:image/' . $type . ';base64,' . base64_encode($data);
				?>

				<img src="<?php echo $base64 ?>" style="height: 48px;">
			</td>
			<td>
