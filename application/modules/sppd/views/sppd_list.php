			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<a href="<?php echo site_url('manage/sppd/add') ?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah</a>
							...
							<tbody>
								...
								if (!empty($sppd)) {
									...
									foreach ($sppd as $row):
										...
										<tr>
											<td><?php echo $i; ?></td>
											<td><?php echo $row['no_sppd']; ?></td>
											<td><?php echo $row['tanggal_input']; ?></td>
											<td><?php echo $row['deskripsi']; ?></td>
											<td><?php echo $row['nama_perintah']; ?></td>
											<td><?php echo $row['nama_diperintah']; ?></td>
											<td><?php echo $row['tmp_tujuan']; ?></td>
											<td><?php echo $row['tgl_berangkat']; ?></td>
											<td><?php echo $row['tgl_kembali']; ?></td>
											<td>
												<a href="<?php echo site_url('manage/sppd/printdata/' . $row['id_sppd']) ?>" class="btn btn-xs btn-primary" target="_blank" data-toggle="tooltip" title="Print"><i class="fa fa-print"></i></a>
												
												<a href="<?php echo site_url('manage/sppd/edit/' . $row['id_sppd']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
												
												<a href="#delModal<?php echo $row['id_sppd']; ?>" data-toggle="modal" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Hapus"></i></a>
											</td>	
										</tr>
										<div class="modal modal-default fade" id="delModal<?php echo $row['id_sppd']; ?>">
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<div class="modal-footer">
															<?php echo form_open('manage/sppd/delete/' . $row['id_sppd']); ?>
