...
class Users_set extends CI_Controller {
  ...
  public function __construct()
  {
    ...
    function modul(){
        $setting = $this->db->query("SELECT setting_value as paket FROM setting WHERE setting_name = 'setting_package'")->row_array();
        ...
        echo "<table class='table table-hover table-responsive'>
            ...
            $sql_menu = "SELECT menu_id, menu_nama FROM navmenu JOIN menu_paket ON menu_paket.navmenu_menu_id = navmenu.menu_id JOIN package ON menu_paket.package_package_id = package.package_id WHERE package_id = '$paket' AND menu_child = '0' ORDER BY menu_order ASC";
            $main_menu = $this->db->query($sql_menu)->result();
            $no = 1;
            foreach ($main_menu as $main) {
            
            $main_id = $main->menu_id;
            $sql_sub = "SELECT menu_id, menu_nama FROM navmenu JOIN menu_paket ON menu_paket.navmenu_menu_id = navmenu.menu_id JOIN package ON menu_paket.package_package_id = package.package_id WHERE package_id = '$paket' AND menu_child = '$main_id' ORDER BY menu_order ASC";
        ...
        echo "<tr>
          ...
          <td align='center'><input type='checkbox' ";
            ...
            $sub_id = $sub->menu_id;
            $sql_child = "SELECT menu_id, menu_nama FROM navmenu JOIN menu_paket ON menu_paket.navmenu_menu_id = navmenu.menu_id JOIN package ON menu_paket.package_package_id = package.package_id WHERE package_id = '$paket' AND menu_child = '$sub_id' ORDER BY menu_order ASC";
