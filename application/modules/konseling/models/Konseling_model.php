...
class Konseling_model extends CI_Model {
	...
	function get($params = array())
	{
		...
		if (isset($params['konseling_mode'])) {
			$this->db->where('konseling_mode', $params['konseling_mode']);
		}
        ...
        // $this->db->where('konseling_mode', '0');
        $this->db->where('majors_status', '1');

		$this->db->select('konseling_id, konseling_period_id, konseling_date, konseling_foul, konseling_action, konseling_poin, konseling_note, konseling_mode');
	...
	function get_konsultasi($params = array())
	{
		if(isset($params['id']))
		{
			$this->db->where('konseling_id', $params['id']);
        ...
        $this->db->where('konseling_mode', '1');
        $this->db->where('majors_status', '1');
	...
	function add($data = array()) {
		...
		if(isset($data['konseling_mode'])) {
			$this->db->set('konseling_mode', $data['konseling_mode']);
		}
