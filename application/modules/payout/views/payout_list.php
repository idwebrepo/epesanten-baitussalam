						...
						<div class="box box-primary">
							...
							<div class="payment">
								...
								<div class="box-body">
									<div class="row">
										...
										<div class="col-md-3">
											...
											<div class="input-group date " data-date="<?php echo date('Y-m-d') ?>" data-date-format="yyyy-mm-dd">
												...
												<input class="form-control" readonly="" required="" type="text" name="kasDate" id="kasDate" value="<?php echo date('Y-m-d'); ?>" placeholder="Pilih Tanggal Kas">
											</div>
										</div>
										<br>
									</div>
									...
									<div class="nav-tabs-custom">
										<ul class="nav nav-tabs">
											...
											<?php if ($paket == '3') { ?>
												<li><a href="#tab_3" data-toggle="tab">Paket</a></li>
											<?php } ?>
										</ul>
										<div class="tab-content">
											<div class="tab-pane active" id="tab_1">
												<div class="box-body table-responsive">
													<label for=""><input type="checkbox" id="selectall2"> Centang Semua</label>
													<table class="table table-bordered" style="white-space: nowrap;">
														...
														<tbody>
															...
															?>
																	<tr>
																		...
																		<td class="<?php echo ($row->status_jul > 0) ? 'success' : 'danger' ?>">
																			<?php if ($row->status_jul == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_jul ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addJul<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_jul > 0) ? number_format($row->bill_jul, 0, ',', '.') . '<br>
													    ...
													    [' . $row->account_jul . ']' : number_format($row->bill_jul, 0, ',', '.') ?></a>
																		...
																		<td class="<?php echo ($row->status_agu > 0) ? 'success' : 'danger' ?>">
																			<?php if ($row->status_agu == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_agu ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addAgu<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_agu > 0) ? number_format($row->bill_agu, 0, ',', '.') . '<br>
													    ...
													    [' . $row->account_agu . ']' : number_format($row->bill_agu, 0, ',', '.') ?></a>
																		...
																		<td class="<?php echo ($row->status_sep > 0) ? 'success' : 'danger' ?>">
																			<?php if ($row->status_sep == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_sep ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addSep<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_sep > 0) ? number_format($row->bill_sep, 0, ',', '.') . '<br>
													    ...
													    [' . $row->account_sep . ']' : number_format($row->bill_sep, 0, ',', '.') ?></a>
																		...
																		<td class="<?php echo ($row->status_okt > 0) ? 'success' : 'danger' ?>">
																			<?php if ($row->status_okt == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_okt ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addOkt<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_okt > 0) ? number_format($row->bill_okt, 0, ',', '.') . '<br>
													    ...
													    [' . $row->account_okt . ']' : number_format($row->bill_okt, 0, ',', '.') ?></a>
																		...
																		<td class="<?php echo ($row->status_nov > 0) ? 'success' : 'danger' ?>">
																			<?php if ($row->status_nov == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_nov ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addNov<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_nov > 0) ? number_format($row->bill_nov, 0, ',', '.') . '<br>
													    ...
													    [' . $row->account_nov . ']' : number_format($row->bill_nov, 0, ',', '.') ?></a>
																		...
																		<td class="<?php echo ($row->status_des > 0) ? 'success' : 'danger' ?>">
																			<?php if ($row->status_des == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_des ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addDes<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_des > 0) ? number_format($row->bill_des, 0, ',', '.') . '<br>
							    ...
							    [' . $row->account_des . ']' : number_format($row->bill_des, 0, ',', '.') ?></a>
																		...
																		<td class="<?php echo ($row->status_jan > 0) ? 'success' : 'danger' ?>">
																			<?php if ($row->status_jan == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_jan ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addJan<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_jan > 0) ? number_format($row->bill_jan, 0, ',', '.') . '<br>
													    ...
													    [' . $row->account_jan . ']' : number_format($row->bill_jan, 0, ',', '.') ?></a>
																		...
																		<td class="<?php echo ($row->status_feb > 0) ? 'success' : 'danger' ?>">

																			<?php if ($row->status_feb == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_feb ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addFeb<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_feb > 0) ? number_format($row->bill_feb, 0, ',', '.') . '<br>
													    ...
													    [' . $row->account_feb . ']' : number_format($row->bill_feb, 0, ',', '.') ?></a>
																		...
																		<td class="<?php echo ($row->status_mar > 0) ? 'success' : 'danger' ?>">

																			<?php if ($row->status_mar == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_mar ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addMar<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_mar > 0) ? number_format($row->bill_mar, 0, ',', '.') . '<br>
													    ...
													    [' . $row->account_mar . ']' : number_format($row->bill_mar, 0, ',', '.') ?></a>
																		...
																		<td class="<?php echo ($row->status_apr > 0) ? 'success' : 'danger' ?>">
																			<?php if ($row->status_apr == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_apr ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addApr<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_apr > 0) ? number_format($row->bill_apr, 0, ',', '.') . '<br>
													    ...
													    [' . $row->account_apr . ']' : number_format($row->bill_apr, 0, ',', '.') ?></a>
																		...
																		<td class="<?php echo ($row->status_mei > 0) ? 'success' : 'danger' ?>">
																			<?php if ($row->status_mei == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_mei ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addMei<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_mei > 0) ? number_format($row->bill_mei, 0, ',', '.') . '<br>
													    ...
													    [' . $row->account_mei . ']' : number_format($row->bill_mei, 0, ',', '.') ?></a>
																		...
																		<td class="<?php echo ($row->status_jun > 0) ? 'success' : 'danger' ?>">
																			<?php if ($row->status_jun == 0) { ?>
																				<input type="checkbox" class="checkbox" name="bulbatch[]" id="bulbatch" value="<?php echo $row->month_id_jun ?>">
																			<?php } ?>
																			<a data-toggle="modal" data-target="#addJun<?php echo $row->payment_id ?>">
																				<?php echo ($row->status_jun > 0) ? number_format($row->bill_jun, 0, ',', '.') . '<br>
													...
													<a data-toggle="modal" class="btn btn-success btn-xs" title="Bayar Banyak" href="#bayarBulanBanyak"><span class="fa fa-money"></span> Bayar Banyak</a>

													<div class="modal fade" id="bayarBulanBanyak" role="dialog">
														<div class="modal-dialog modal-md">
															<div class="modal-content">
																<div class="modal-header">
																	<button type="button" class="close" data-dismiss="modal">&times;</button>
																	<h4 class="modal-title">Bayar Banyak Bulanan</h4>
																</div>
																<div class="modal-body">

																	<div class="form-group">
																		<input type="checkbox" id="cond" name="cond">
																		Migrasi Data Pembayaran

																	</div>
																</div>
																<div class="modal-footer">
																	<button type="button" class="btn btn-success" id="bulanBanyak" title="Bayar Banyak"><span class="fa fa-money"></span> Bayar</bulan>
											...
											<?php if ($paket == '3') { ?>
												<div class="tab-pane" id="tab_3">
													<div class="box-body table-responsive">
														<label for=""><input type="checkbox" id="selectall3"> Centang Semua</label>
														<table class="table table-bordered" style="white-space: nowrap;">
															<thead>
																<tr class="info">
																	<th>No.</th>
															...
															<tbody>
																<?php
																$no = 1;
																$num = count((array)$pembayaran_batch);
																if ($num > 0) {
																	foreach ($pembayaran_batch as $row) {
																?>
																		<tr>
																			<td>
																				<?php
																			...
																			<td>
																				<?php
																				echo $row->name . ' - T.A. ' . $row->period_start . '/' . $row->period_end
																				?>
																				<a href="<?php echo site_url('manage/payout/payout_paket/' . $row->id . '/' . $row->student_id) ?>" class="view-paket label label-default"><i class="fa fa-info-circle"></i> </a>
																			</td>
																			<td><?php echo ($row->total == $row->dibayar) ? 'Rp. -' : 'Rp. ' . number_format($row->total - $row->dibayar, 0, ',', '.') ?></td>
																			<td class="<?php echo ($row->status_jul > 0) ? 'success' : 'danger' ?>">
																				<?php
																				if ($row->status_jul == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_jul ?>">
																				<?php } ?>

																				<?php
																				$billJul = explode(',', $row->bill_jul);
																				$sumJul = array_sum($billJul);
																				?>
																				<a data-toggle="modal" data-target="#addJul<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_jul > 0) ? number_format(floatval($sumJul), 0, ',', '.') . '<br>
													    (' . pretty_date($row->date_pay_jul, 'd/m/y', false) . ')<br>
													    [' . $row->account_jul . ']' : number_format(floatval($sumJul), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addJul<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_jul ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_jul_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="item" value="<?php echo $row->name . ' - T.A. ' . $row->period_start . '/' . $row->period_end . ' ' . $row->month_name_jul ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_jul ?>">
																								<input class="form-control" required="" type="hidden" name="payout_value" value="<?php echo $row->bill_jul ?>">
																								<div class="form-group">
																									<label>Tanggal</label>
																									<div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
																										<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" type="text" placeholder="Jumlah Bayar" readonly value="<?php echo number_format($sumJul, 0, ',', '.') ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_jul == '1')) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_jul) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
																			...
																			<td class="<?php echo ($row->status_agu > 0) ? 'success' : 'danger' ?>">
																				<?php if ($row->status_agu == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_agu ?>">
																				<?php } ?>

																				<?php
																				$billAgu = explode(',', $row->bill_agu);
																				$sumAgu = array_sum($billAgu);
																				?>
																				<a data-toggle="modal" data-target="#addAgu<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_agu > 0) ? number_format(floatval($sumAgu), 0, ',', '.') . '<br>
													    (' . pretty_date($row->date_pay_agu, 'd/m/y', false) . ')<br>
													    [' . $row->account_agu . ']' : number_format(floatval($sumAgu), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addAgu<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_agu ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_agu_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_agu ?>">
																								<input class="form-control" required="" type="hidden" name="payout_value" value="<?php echo $row->bill_agu ?>">
																								<div class="form-group">
																									<label>Tanggal</label>
																									<div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
																										<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" type="text" placeholder="Jumlah Bayar" readonly value="<?php echo number_format($sumAgu, 0, ',', '.') ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_agu > 0)) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_agu) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
																			...
																			<td class="<?php echo ($row->status_sep > 0) ? 'success' : 'danger' ?>">
																				<?php if ($row->status_sep == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_sep ?>">
																				<?php } ?>

																				<?php
																				$billSep = explode(',', $row->bill_sep);
																				$sumSep = array_sum($billSep);
																				?>
																				<a data-toggle="modal" data-target="#addSep<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_sep > 0) ? number_format(floatval($sumSep), 0, ',', '.') . '<br>
													    (' . pretty_date($row->date_pay_sep, 'd/m/y', false) . ')<br>
													    [' . $row->account_sep . ']' : number_format(floatval($sumSep), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addSep<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_sep ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_sep_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_sep ?>">
																								<input class="form-control" required="" type="hidden" name="payout_value" value="<?php echo $row->bill_sep ?>">
																								<div class="form-group">
																									<label>Tanggal</label>
																									<div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
																										<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" type="text" placeholder="Jumlah Bayar" readonly value="<?php echo number_format($sumSep, 0, ',', '.') ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_sep > 0)) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_sep) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
																			...
																			<td class="<?php echo ($row->status_okt > 0) ? 'success' : 'danger' ?>">
																				<?php if ($row->status_okt == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_okt ?>">
																				<?php } ?>
																				<?php
																				$billOkt = explode(',', $row->bill_okt);
																				$sumOkt = array_sum($billOkt);
																				?>
																				<a data-toggle="modal" data-target="#addOkt<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_okt > 0) ? number_format(floatval($sumOkt), 0, ',', '.') . '<br>
													    (' . pretty_date($row->date_pay_okt, 'd/m/y', false) . ')<br>
													    [' . $row->account_okt . ']' : number_format(floatval($sumOkt), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addOkt<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_okt ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_okt_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_okt ?>">
																								<input class="form-control" required="" type="hidden" name="payout_value" value="<?php echo $row->month_id_okt ?>">
																								<div class="form-group">
																									<label>Tanggal</label>
																									<div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
																										<span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" type="text" placeholder="Jumlah Bayar" readonly value="<?php echo number_format($sumOkt, 0, ',', '.') ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_okt > 0)) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_okt) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
																			...
																			<td class="<?php echo ($row->status_nov > 0) ? 'success' : 'danger' ?>">
																				<?php if ($row->status_nov == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_nov ?>">
																				<?php } ?>
																				<?php
																				$billNov = explode(',', $row->bill_nov);
																				$sumNov = array_sum($billNov);
																				?>
																				<a data-toggle="modal" data-target="#addNov<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_nov > 0) ? number_format(floatval($sumNov), 0, ',', '.') . '<br>
													    (' . pretty_date($row->date_pay_nov, 'd/m/y', false) . ')<br>
													    [' . $row->account_nov . ']' : number_format(floatval($sumNov), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addNov<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_nov ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_nov_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_nov ?>">
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" readonly type="text" name="payout_value" placeholder="Jumlah Bayar" value="<?php echo $row->bill_nov ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_nov > 0)) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_nov) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
																			...
																			<td class="<?php echo ($row->status_des > 0) ? 'success' : 'danger' ?>">
																				<?php if ($row->status_des == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_des ?>">
																				<?php } ?>
																				<?php
																				$billDes = explode(',', $row->bill_des);
																				$sumDes = array_sum($billDes);
																				?>
																				<a data-toggle="modal" data-target="#addDes<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_des > 0) ? number_format(floatval($sumDes), 0, ',', '.') . '<br>
							    (' . pretty_date($row->date_pay_des, 'd/m/y', false) . ')<br>
							    [' . $row->account_des . ']' : number_format(floatval($sumDes), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addDes<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_des ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_des_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_des ?>">
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" readonly type="text" name="payout_value" placeholder="Jumlah Bayar" value="<?php echo $row->bill_des ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_des > 0)) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_des) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
																			...
																			<td class="<?php echo ($row->status_jan > 0) ? 'success' : 'danger' ?>">
																				<?php if ($row->status_jan == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_jan ?>">
																				<?php } ?>
																				<?php
																				$billJan = explode(',', $row->bill_jan);
																				$sumJan = array_sum($billJan);
																				?>
																				<a data-toggle="modal" data-target="#addJan<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_jan > 0) ? number_format(floatval($sumJan), 0, ',', '.') . '<br>
													    (' . pretty_date($row->date_pay_jan, 'd/m/y', false) . ')<br>
													    [' . $row->account_jan . ']' : number_format(floatval($sumJan), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addJan<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_jan ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_jan_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_jan ?>">
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" readonly type="text" name="payout_value" placeholder="Jumlah Bayar" value="<?php echo $row->bill_jan ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_jan > 0)) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_jan) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
																			...
																			<td class="<?php echo ($row->status_feb > 0) ? 'success' : 'danger' ?>">
																				...
																				<?php if ($row->status_feb == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_feb ?>">
																				<?php } ?>
																				<?php
																				$billFeb = explode(',', $row->bill_feb);
																				$sumFeb = array_sum($billFeb);
																				?>
																				<a data-toggle="modal" data-target="#addFeb<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_feb > 0) ? number_format(floatval($sumFeb), 0, ',', '.') . '<br>
													    (' . pretty_date($row->date_pay_feb, 'd/m/y', false) . ')<br>
													    [' . $row->account_feb . ']' : number_format(floatval($sumFeb), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addFeb<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_feb ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_feb_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_feb ?>">
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" readonly type="text" name="payout_value" placeholder="Jumlah Bayar" value="<?php echo $row->bill_feb ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_feb > 0)) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_feb) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
																			...
																			<td class="<?php echo ($row->status_mar > 0) ? 'success' : 'danger' ?>">
																				...
																				<?php if ($row->status_mar == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_mar ?>">
																				<?php } ?>
																				<?php
																				$billMar = explode(',', $row->bill_mar);
																				$sumMar = array_sum($billMar);
																				?>
																				<a data-toggle="modal" data-target="#addMar<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_mar > 0) ? number_format(floatval($sumMar), 0, ',', '.') . '<br>
													    (' . pretty_date($row->date_pay_mar, 'd/m/y', false) . ')<br>
													    [' . $row->account_mar . ']' : number_format(floatval($sumMar), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addMar<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_mar ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_mar_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_mar ?>">
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" readonly type="text" name="payout_value" placeholder="Jumlah Bayar" value="<?php echo $row->bill_mar ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_mar > 0)) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_mar) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
																			...
																			<td class="<?php echo ($row->status_apr > 0) ? 'success' : 'danger' ?>">
																				<?php if ($row->status_apr == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_apr ?>">
																				<?php } ?>
																				<?php
																				$billApr = explode(',', $row->bill_apr);
																				$sumApr = array_sum($billApr);
																				?>
																				<a data-toggle="modal" data-target="#addApr<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_apr > 0) ? number_format(floatval($sumApr), 0, ',', '.') . '<br>
													    (' . pretty_date($row->date_pay_apr, 'd/m/y', false) . ')<br>
													    [' . $row->account_apr . ']' : number_format(floatval($sumApr), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addApr<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_apr ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_apr_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_apr ?>">
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" readonly type="text" name="payout_value" placeholder="Jumlah Bayar" value="<?php echo $row->bill_apr ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_apr > 0)) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_apr) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
																			...
																			<td class="<?php echo ($row->status_mei > 0) ? 'success' : 'danger' ?>">
																				<?php if ($row->status_mei == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_mei ?>">
																				<?php } ?>
																				<?php
																				$billMei = explode(',', $row->bill_mei);
																				$sumMei = array_sum($billMei);
																				?>
																				<a data-toggle="modal" data-target="#addMei<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_mei > 0) ? number_format(floatval($sumMei), 0, ',', '.') . '<br>
													    (' . pretty_date($row->date_pay_mei, 'd/m/y', false) . ')<br>
													    [' . $row->account_mei . ']' : number_format(floatval($sumMei), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addMei<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_mei ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_mei_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_mei ?>">
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" readonly type="text" name="payout_value" placeholder="Jumlah Bayar" value="<?php echo $row->bill_mei ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_mei > 0)) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_mei) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
																			...
																			<td class="<?php echo ($row->status_jun > 0) ? 'success' : 'danger' ?>">
																				<?php if ($row->status_jun == 0) { ?>
																					<input type="checkbox" class="checkbox" name="batchpay[]" id="batchpay" value="<?php echo $row->month_id_jun ?>">
																				<?php } ?>
																				<?php
																				$billJun = explode(',', $row->bill_jun);
																				$sumJun = array_sum($billJun);
																				?>
																				<a data-toggle="modal" data-target="#addJun<?php echo $row->payment_id ?>">
																					<?php echo ($row->status_jun > 0) ? number_format(floatval($sumJun), 0, ',', '.') . '<br>
													    (' . pretty_date($row->date_pay_jun, 'd/m/y', false) . ')<br>
													    [' . $row->account_jun . ']' : number_format(floatval($sumJun), 0, ',', '.') ?></a>
																				<div class="modal fade" id="addJun<?php echo $row->payment_id ?>" role="dialog">
																					<div class="modal-dialog modal-sm">
																						<div class="modal-content">
																							<div class="modal-header">
																								<button type="button" class="close" data-dismiss="modal">&times;</button>
																								<h4 class="modal-title">Pembayaran Paket Bulan <?php echo $row->month_name_jun ?></h4>
																							</div>
																							<?php echo form_open('manage/payout/pay_paket', array('method' => 'post')); ?>
																							<div class="modal-body">
																								<input class="form-control" required="" type="hidden" name="kas_noref" value="<?php echo $noref ?>">
																								<input class="form-control" required="" type="hidden" name="kas_account" id="kas_account_jun_batch<?php echo $row->payment_id ?>" value="<?php echo $dataKasActive ?>">
																								<input class="form-control" required="" type="hidden" name="student_id" value="<?php echo $row->student_id ?>">
																								<input class="form-control" required="" type="hidden" name="student_nis" value="<?php echo $row->student_nis ?>">
																								<input class="form-control" required="" type="hidden" name="payment_period" value="<?php echo $row->period_id ?>">
																								<input class="form-control" required="" type="hidden" name="payout_id" value="<?php echo $row->month_id_jun ?>">
																								...
																								<div class="form-group">
																									<label>Jumlah Bayar</label>
																									<input class="form-control" readonly type="text" name="payout_value" placeholder="Jumlah Bayar" value="<?php echo $row->bill_jun ?>">
																								</div>
																							</div>
																							<div class="modal-footer">
																								<?php if (($row->status_jun > 0)) { ?>
																									<a href="<?php echo site_url('manage/payout/not_pay_paket/?p=' . $row->payment_id . '&s=' . $row->student_id . '&b=' . $row->month_id_jun) ?>"><button type="button" class="btn btn-danger">Hapus</button></a>
																								<?php } else { ?>
																									<button type="submit" class="btn btn-success">Simpan</button>
																								<?php } ?>
																								<button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
														...
														<a data-toggle="modal" class="btn btn-success btn-xs" title="Bayar Banyak" href="#bayarPaketBanyak"><span class="fa fa-money"></span> Bayar Banyak</a>

														<div class="modal fade" id="bayarPaketBanyak" role="dialog">
															<div class="modal-dialog modal-md">
																<div class="modal-content">
																	<div class="modal-header">
																		<button type="button" class="close" data-dismiss="modal">&times;</button>
																		<h4 class="modal-title">Bayar Banyak Paket</h4>
																	</div>
																	<div class="modal-body">

																		<div class="form-group">
																			<input type="checkbox" id="condBatch" name="condBatch">
																			Migrasi Data Pembayaran

																		</div>
																	</div>
																	<div class="modal-footer">
																		<button type="button" class="btn btn-success" id="paketBanyak" title="Bayar Banyak"><span class="fa fa-money"></span> Bayar</bulan>
																			<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
																	</div>
																</div>
															</div>
																				...
																				<div class="over">
																					<table class="table table-responsive table-bordered" style="white-space: nowrap;">
																						...
																						<tbody>
																							...
																							$paket = $this->Billing_model->get_tagihan_paket($params);
																							...
																							foreach ($paket as $row) : ?>
																								<tr>
																									<td><?php echo $row['name'] . ' - T.A ' . $row['period_start'] . '/' . $row['period_end'] . '-' . $row['month_name'] ?>
																									</td>
																									<td align="right">
																										Rp
																									</td>
																									<td align="right">
																										<?php echo number_format($row['paket_bill'], 0, ",", ".") ?>
																									</td>
																									<?php $billPaket += $row['paket_bill']; ?>
																								</tr>
																							<?php endforeach; ?>
																						</tbody>
																					</table>
																				...
																				<table class="table table-responsive table-bordered" style="white-space: nowrap;">
																					<tbody>
																						<tr style="background-color: #f0f0f0">
																							...
																							<td align="right">
																								<?php echo number_format($billBulan + $billBebas + $billPaket, 0, ",", ".") ?>
																							</td>
																						</tr>
																					</tbody>
																				</table>
...
<script>
	...
	<?php if ($f) { ?>
		...
		function change_kas_account() {
			...
			<?php if (count((array)$pembayaran_batch) > 0) {
				foreach ($pembayaran_batch as $row) { ?>

					$("#kas_account_jul_batch<?php echo $row->payment_id ?>").val(kas);
					$("#kas_account_agu_batch<?php echo $row->payment_id ?>").val(kas);
					$("#kas_account_sep_batch<?php echo $row->payment_id ?>").val(kas);
					$("#kas_account_okt_batch<?php echo $row->payment_id ?>").val(kas);
					$("#kas_account_nov_batch<?php echo $row->payment_id ?>").val(kas);
					$("#kas_account_des_batch<?php echo $row->payment_id ?>").val(kas);
					$("#kas_account_jan_batch<?php echo $row->payment_id ?>").val(kas);
					$("#kas_account_feb_batch<?php echo $row->payment_id ?>").val(kas);
					$("#kas_account_mar_batch<?php echo $row->payment_id ?>").val(kas);
					$("#kas_account_apr_batch<?php echo $row->payment_id ?>").val(kas);
					$("#kas_account_mei_batch<?php echo $row->payment_id ?>").val(kas);
					$("#kas_account_jun_batch<?php echo $row->payment_id ?>").val(kas);

				<?php }
			} else  if (count((array)$pembayaran) > 0) {
				foreach ($pembayaran as $row) { ?>
...
<script>
	...
	$(document).ready(function() {
		$("#selectall2").change(function() {
			$('#bulbatch:enabled').prop('checked', this.checked);
		});
	});
</script>
...
<script>
	$(document).ready(function() {
		...
		$('#bulanBanyak').click(function() {

			bulanArray.length = 0;

			$('#bulbatch:checked').each(function() {

				let bulanValue = $(this).val();

				bulanArray.push(bulanValue);
			});

			var isChecked = $('#cond').prop('checked');
			...
			let data = {
				...
				additionals: {
					nis: $('#student_nis').val(),
					period: $('#th_ajar').val(),
					kas: $('#kas_account_id').val(),
					noref: $('#kas_noref').val(),
					cond: condition
				}
			};

			let payBul = bulanArray.length;

			let kas_noref = $('#kas_noref').val();
			let kas_account_id = $('#kas_account_id').val();
			let period = $('#th_ajar').val();
			let nis = $('#student_nis').val();

			if (payBul > 0 && kas_noref != '' && kas_account_id != '') {

				$.ajax({
					url: '<?php echo base_url(); ?>manage/payout/pay_batch/',
					method: 'POST',
				...
				alert('Masih Ada Kolom yang Kosong');
			}
		});
	});
</script>
...
<script>
	$(document).ready(function() {
		...
		$('#paketBanyak').click(function() {

			paketArray.length = 0;

			$('#batchpay:checked').each(function() {

				let paketValue = $(this).val();

				paketArray.push(paketValue);
			});

			var isChecked = $('#condBatch').prop('checked');
			...
			let payPaket = paketArray.length;
			...
			if (payPaket > 0 && kas_noref != '' && kas_account_id != '') {

				$.ajax({
					url: '<?php echo base_url(); ?>manage/payout/pay_paket_batch/',
					method: 'POST',
					contentType: 'application/json',
					data: JSON.stringify(data),
					success: function(response) {
