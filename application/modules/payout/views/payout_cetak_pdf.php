...
<body>
	...
	<table>
	    <tr>
	        <td width="6%">
	            <img src="<?php echo base_url() . 'uploads/school/' . logo() ?>" style="height: 50px;">
	        </td>
	        <td>
            	...
            	echo '<p class="unit">';
                  ...
                  <p class="alamat"><?php echo $setting_address['setting_value'] ?><?php echo ' Telp. '.$setting_phone['setting_value'] ?><?php echo '<br> Email : '.$setting_email['setting_value'] ?></p>
        	</td>
	    </tr>
	</table>
	<!--<p class="name-school"><?php echo $setting_school['setting_value'] ?></p>
