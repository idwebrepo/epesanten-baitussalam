											...
											<div class="row">
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<textarea class="form-control" required="" name="guest_list_note" class="form-control" placeholder="Masukkan Keterangan"></textarea>
													</div>
												</div>
												...
												<div class="col-md-12">
													<div class="form-group">
														<label>Penjenguk/Mahram
															<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#addMahram<?php foreach ($siswa as $student): echo $student['student_id'];
																																							endforeach; ?>"><i class="fa fa-plus"></i> Tambah Mahram</button></label>
														<table>
															<tr>
																<td>
																...
																<div class="modal modal-default fade" id="delMahram<?php echo $row['guest_id']; ?>">
																	<div class="modal-dialog">
																		<div class="modal-content">
																			...
																			<div class="modal-footer">
																				<button type="button" class="btn btn-default pull-left" data-dismiss="modal"><span class="fa fa-close"></span> Batal</button>
																				<button type="button" data-id="<?php echo $row['guest_id']; ?>" data-student="<?php echo $row['guest_student_id']; ?>" class="btnDelMahram btn btn-danger"><span class="fa fa-check"></span> Hapus</button>
																			</div>
																		</div>
																		<!-- /.modal-content -->
																	</div>
...
<div class="modal fade" id="addMahram<?php foreach ($siswa as $student): echo $student['student_id'];
										endforeach; ?>" role="dialog">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<?php echo form_open('manage/visit/add_mahram', array('method' => 'post', 'id' => 'addMahramForm')); ?>
			<div class="modal-body">
				<input type="hidden" name="period" value="<?php echo $f['n'] ?>">
				<input type="hidden" name="nis" value="<?php echo $f['r'] ?>">
				<input type="hidden" class="form-control" required="" name="student_id" value="<?php foreach ($siswa as $student): echo $student['student_id'];
																								endforeach; ?>">
				<div id="p_scents_family">
					<div class="row">
						...
						<div class="col-md-2">
							<a href="#" class="btn btn-danger btn-sm remScnt_family"><i class="fa fa-minus"></i></a>
						</div>
					</div>
				</div>
				<h6><a href="#" class="btn btn-success btn-xs" id="addScnt_family"><i class="fa fa-plus"></i><b> Tambah Baris</b></a></h6>
...
<script>
	$(".btnDelMahram").click(function() {
		var idMahram = $(this).data("id");
		var dataMahram = {
		...
		$.ajax({
			url: '<?php echo base_url() ?>manage/visit/delete_mahram/' + idMahram,
			method: 'post',
			data: dataMahram, // Data yang akan dikirim
