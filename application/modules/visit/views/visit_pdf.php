...
<body>
	...
	<table style="padding-top: 0px; padding-bottom: 0px">
		...
		<tr>
			<td style="width: 100%;"><?php echo ($visit['madin_name'] == '' ? '-' : $visit['madin_name']) ?></td>
		</tr>
		<tr>
		...
		<tr>
			<td style="width: 100%;"><?php echo $visit['guest_list_note'] ?></td>
		</tr>
		<tr>
	...
	<table style="border-style: solid;">
		...
		<tr>
			<td colspan="4" style="text-align: center">Wajib diberikan kepada petugas sebelum masuk ke pesantren</td>
		</tr>
	</table>
	<br>
