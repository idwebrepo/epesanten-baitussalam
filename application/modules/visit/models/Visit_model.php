...
class Visit_model extends CI_Model {
	...
	function get($params = array())
	{
		...
		$this->db->select('guest_list_id, guest_list_code, guest_list_period_id, guest_list_note, guest_list_date, guest_list_time');
	...
	function add($data = array()) {
		...
		if(isset($data['guest_list_note'])) {
			$this->db->set('guest_list_note', $data['guest_list_note']);
		}
