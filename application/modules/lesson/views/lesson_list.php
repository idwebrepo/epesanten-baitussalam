			...
			<div class="modal-body">
				...
				<div id="p_scents_lesson">
					<p>
						...
						<select id="lesson_teacher" name="lesson_teacher[]" class="form-control">
							<option value="">--- Pilih Pengajar ---</option>
							<?php foreach ($employee as $row) { ?>
								<option value="<?php echo $row['employee_id']; ?>"><?php echo str_replace("'", "`", $row['employee_name']); ?></option>
							<?php } ?>
						</select>
					</p>
				</div>
