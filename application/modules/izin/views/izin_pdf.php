...
<head>
	<title><?php echo 'Surat_izin_keluar_' . $izin['student_full_name'] ?></title>
</head>
...
<body>
	...
	<table>
		<tr>
			<td>
				<p class="name-school" align="center">Surat Izin Keluar Pesantren</p>
			</td>
		</tr>
	</table>
	<br>
	<table style="padding-top: -5px; padding-bottom: 5px">
		...
		<tr>
			<th style="width: 100%;">Kelas Pondok</th>
		</tr>
		<tr>
			<td style="width: 100%;"><?php echo ($izin['madin_name'] == '' ? '-' : $izin['madin_name']) ?></td>
		</tr>
		<tr>
		...
		<tr>
			<td style="width: 100%;"><?php echo $izin['izin_note'] ?></td>
		</tr>
	...
	<table style="border-style: solid;">
		...
		<tr>
			<td colspan="4" style="text-align: center">Wajib dikembalikan kepada pemberi izin sebelum batas waktu berakhir</td>
		</tr>
	</table>
	<br>
