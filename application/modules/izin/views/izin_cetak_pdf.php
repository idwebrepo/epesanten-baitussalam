	...
	<table style="border-style: solid;">
		...
		?>
			<tr>
				...
				<td style="border-bottom: 1px solid;"><?php echo $row['izin_note'] ?></td>
			</tr>
		<?php
			$i++;
		endforeach ?>
		<tr>
			<td colspan="3" style="background-color: #dedede; font-weight:bold; border-bottom: 1px solid;">Total Izin</td>
