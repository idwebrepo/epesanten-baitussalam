...
<head>
	<title><?php echo 'Data_Alumni_' . $majors['majors_short_name'] . '_Kelas_' . $kelas['class_name'] . '_Kelas Pondok_' . $madin['madin_name']; ?></title>
</head>
...
<body>
	...
	<table style='width: 277mm;'>
		<tr>
			...
			<td style='width: 93mm; font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Data Alumni ' . $majors['majors_short_name'] . ' Kelas ' . $kelas['class_name'] . ' Kelas Pondok ' . $madin['madin_name']; ?></b></td>
			<td style='width: 92mm; font-size: 8pt;' align='right'></td>
		</tr>

		<tr>
			<td style='width: 92mm; font-size: 8pt; text-align: center' valign='center'></td>
			<td style='width: 93mm; font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Tahun ' . $period['period_end']; ?></b></td>
			<td style='width: 92mm; font-size: 8pt;' align='right'></td>
		</tr>
	</table>
	<br>
	<table cellpadding='0' cellspacing='0' style='width: 277mm;'>
		...
		?>
			<tr valign='top'>
				...
				<td style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo $row['alumni_nis'] ?></td>
				<td style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo $row['alumni_nisn'] ?></td>
				<td style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo $row['alumni_full_name'] ?></td>
				<td align="center" style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo $row['alumni_gender'] ?></td>
				<td style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo $row['alumni_address'] ?></td>
				<td style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo $row['alumni_name_of_father'] ?></td>
				<td style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo $row['alumni_name_of_mother'] ?></td>
				<td style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo $row['alumni_parent_phone'] ?></td>
			</tr>
		<?php } ?>
	</table>
</body>
