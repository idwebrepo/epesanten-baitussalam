			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addKelasPondok"><i class="fa fa-plus"></i> Tambah</button>
					...
					<div class="box-body table-responsive">
						<table id="dtable" class="table table-hover">
							<thead>
								<tr>
									<th>No</th>
									<th>Nama Kelas Pondok</th>
									<th>ID Kelas Pondok</th>
									<!--<th>Unit Sekolah</th>-->
									<!--<th>ID Unit</th>-->
									<th>Aksi</th>
								</tr>
							...
							<tbody>
								...
								?>
										<tr>
											...
											<!--<td><?php //echo $row['majors_short_name']; 
													?></td>-->
											<!--<td><?php //echo $row['madin_majors_id']; 
													?></td>-->
											<td>
...
<!-- Modal -->
<div class="modal fade" id="addKelasPondok" role="dialog">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="modal-title">Tambah Kelas Pondok</h4>
			</div>
...
<script>
	$(function() {
		...
		$("#addScnt_madin").click(function() {
			$('<p><label>Nama Kelas Pondok</label><input required type="text" name="madin_name[]" class="form-control" placeholder="Contoh: X (A)"><a href="#" class="btn btn-xs btn-danger remScnt_madin">Hapus Baris</a></p>').appendTo(scntDiv);
			i++;
			return false;
		});
