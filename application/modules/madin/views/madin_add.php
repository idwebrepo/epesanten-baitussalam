				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="form-group">
							<label>Kelas Pondok <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
							<input name="madin_name" type="text" class="form-control" value="<?php echo $inputMadinValue ?>" placeholder="Isi Kelas Pondok">
						</div>
