			...
			<div class="col-xs-12">
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Data Hutang - <?php echo $settinghutang['poshutang_name'] . ' - T.A ' . $settinghutang['period_start'] . '/' . $settinghutang['period_end']; ?></h3>
					</div><!-- /.box-header -->
					<div class="box-body">
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td style="text-align: center;"><?php echo pretty_date($row['hutang_date'], 'd-m-Y', false); ?></td>
										<td><?php echo $row['hutang_kreditur']; ?></td>
