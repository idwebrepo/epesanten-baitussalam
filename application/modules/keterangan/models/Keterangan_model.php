...
class Keterangan_model extends CI_Model {
	...
	function get($params = array())
	{
		...
		$this->db->select('keterangan_id, keterangan_nama, keterangan_isi, keterangan_update, keterangan_kop');
        
		$res = $this->db->get('jenis_keterangan');
	...
	function add($data = array()) {
		...
		if(isset($data['keterangan_id'])) {
			$this->db->set('keterangan_id', $data['keterangan_id']);
		}

		if(isset($data['keterangan_nama'])) {
			$this->db->set('keterangan_nama', $data['keterangan_nama']);
		}

		if(isset($data['keterangan_isi'])) {
			$this->db->set('keterangan_isi', $data['keterangan_isi']);
		}

		if(isset($data['keterangan_kop'])) {
			$this->db->set('keterangan_kop', $data['keterangan_kop']);
		}
        
		if (isset($data['keterangan_id'])) {
			$this->db->where('keterangan_id', $data['keterangan_id']);
			$this->db->update('jenis_keterangan');
			$id = $data['keterangan_id'];
		} else {
			$this->db->insert('jenis_keterangan');
	...
	function delete($id) {
		...
		$this->db->delete('jenis_keterangan');
	}
