				...
				<div class="box box-success">
					<div class="box-header">
						...
						<div class="row">
							...
							<a class="btn btn-success" target="_blank" href="<?php echo site_url('pegawai/presensi_harian/report_print' . '/?' . http_build_query($q)) ?>"><i class="fa fa-file-excel-o" ></i> Cetak</a>
							<?php } ?>
						    </div>
					        </div>
					</div>
...
<script>
    function get_kelas(){
        ...
        $.ajax({ 
            url: '<?php echo base_url();?>pegawai/billing/class_searching',
            type: 'POST', 
            data: {
                    'id_majors': id_majors,
            },    
