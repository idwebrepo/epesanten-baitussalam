...
class Presensi_halaqoh_set extends CI_Controller {
    ...
    public function index($offset = NULL) {
        ...
        $data['main'] = 'presensi_halaqoh/presensi_halaqoh_list';
    ...
    public function report($offset = NULL) {
        ...
        $data['main'] = 'presensi_halaqoh/presensi_halaqoh_report';
        $this->load->view('manage/layout', $data);
    }
    ...
    public function add_glob(){
        ...
        redirect('manage/presensi_halaqoh?h=' . $halaqohID . '&k=' . $kegiatan_id . '&d=' . $presensiDate);
    }
