...
if (isset($paket)) {
	$inputNameValue = $paket['name'];
	$inputMajorsValue = $paket['bp_majors_id'];
	$inputPeriodValue = $paket['bp_period_id'];
} else {
	$inputNameValue = set_value('name');
	$inputMajorsValue = set_value('bp_majors_id');
	$inputPeriodValue = set_value('bp_period_id');
}
?>
...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo site_url('manage/batchpayment') ?>">Unit POS</a></li>
			...
			<div class="col-md-3">
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<a href="<?php echo site_url('manage/batchpayment'); ?>" class="btn btn-block btn-info">Batal</a>
					</div>
					<!-- /.box-body -->
				</div>
			</div>
