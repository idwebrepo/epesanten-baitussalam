					...
					<div class="box-header">
						...
						<table>
						    <tr>
        					    ...
        					    <td>
									<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#printEmployee"><i class="fa fa-print"></i> Cetak</button>
        					    </td>
        					    <td>
						<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#xlsEmployee"><i class="fa fa-file-excel-o"></i> Export Xls</button>
        					    </td>
						    </tr>      
						</table>
	...
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Pilih Unit/Jabatan</h4>
			</div>
			<form action="<?php echo base_url(); ?>manage/employees/print_employees" method="post" target="_blank">
				<div class="modal-body">
					...
					<select required="" name="modal_majors" id="modal_majors" class="form-control">
						...
						<?php foreach ($majors as $row) { ?>
							<option value="<?php echo $row['majors_id'] ?>"><?php echo html_escape($row['majors_short_name']) ?></option>
						<?php } ?>
					</select>
					<label>Jabatan</label>
					<select required="" name="modal_position" id="modal_position" class="form-control">
						<option value="">--- Pilih Jabatan ---</option>
						<option value="all">Semua Jabatan</option>
						<?php foreach($position as $row){?>
							<option value="<?php echo $row['position_id']; ?>"><?php echo html_escape($row['position_name']) ?></option>
						<?php } ?>
					</select>
				</div>
...
<div class="modal fade" id="xlsEmployee" role="dialog">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
			...
			<form action="<?php echo base_url(); ?>manage/employees/excel_employees" method="post" target="_blank">
			...
			<div class="modal-body">
					...
					<label>Jabatan</label>
					<select required="" name="xls_position" id="xls_position" class="form-control">
						<option value="">--- Pilih Jabatan ---</option>
						<option value="all">Semua Jabatan</option>
						<?php foreach($position as $row){?>
							<option value="<?php echo $row['position_id']; ?>"><?php echo html_escape($row['position_name']) ?></option>
