				...
				<div class="box box-success">
					...
					<div class="box-body">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<h3>Daftar Dokumen/Berkas</h3>
							<button type="button" class="btn btn-success btn-xs" data-toggle="modal" data-target="#addDokumen<?php echo $id; ?>"><i class="fa fa-plus"></i> Tambah</button>
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td>
												<a href="<?= base_url() . 'uploads/dokumen/berkas/' . $row['dokumen_file'] ?>" target="_blank" class="btn btn-sm btn-info">Lihat</a>
											</td>
											<td>
												<?php echo $row['dokumen_note'] ?>
											</td>
											<td>
												<a href="#delDok<?php echo $row['dokumen_id']; ?>" data-toggle="modal" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Hapus"></i></a>
											</td>
										</tr>
										<div class="modal modal-default fade" id="delDok<?php echo $row['dokumen_id']; ?>">
											<div class="modal-dialog">
												<div class="modal-content">
													<div class="modal-header">
														<button type="button" class="close" data-dismiss="modal" aria-label="Close">
													...
													<div class="modal-footer">
														<?php echo form_open('manage/employees/delete_dokumen/' . $row['dokumen_id']); ?>
														<input type="hidden" name="employee_id" value="<?php echo $row['dokumen_employee_id']; ?>">
														<button type="button" class="btn btn-default pull-left" data-dismiss="modal"><span class="fa fa-close"></span> Batal</button>
														<button type="submit" class="btn btn-danger"><span class="fa fa-check"></span> Hapus</button>
														<?php echo form_close(); ?>
													</div>
...
<!-- Modal -->
<!-- Education -->
<div class="modal fade" id="addDokumen<?php echo $id ?>" role="dialog">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<?php echo form_open_multipart('manage/employees/add_dokumen', array('method' => 'post')); ?>
			<div class="modal-body">
				<input type="hidden" class="form-control" required="" name="employee_id" value="<?php echo $id ?>">
				<div id="p_scents_dokumen">
					<div class="row">
						<div class="col-md-6">
							<label>Berkas/Dokumen (.jpg/.png/.pdf) *</label>
							<input type="file" class="form-control" required="" name="dokumen_file[]" class="form-control">
						</div>
						<div class="col-md-6">
							<label>Keterangan *</label>
							<input type="text" class="form-control" required="" name="dokumen_note[]" class="form-control" placeholder="Berkas Ijazah">
						</div>
					</div>
				</div>
				<h6><a href="#" class="btn btn-xs btn-success" id="addScnt_dokumen"><i class="fa fa-plus"></i><b> Tambah Baris</b></a></h6>
...
<script>
	$(function() {
		var scntDok = $('#p_scents_dokumen');
		var x = $('#p_scents_dokumen .row').size() + 1;
		$("#addScnt_dokumen").click(function() {
			$('<div class="row"><div class="col-md-6"><label>Berkas/Dokumen (.jpg/.png/.pdf) *</label><input type="file" class="form-control" required="" name="dokumen_file[]" class="form-control"><a href="#" class="btn btn-xs btn-danger remScnt_dokumen">Hapus Baris</a></div><div class="col-md-6"><label>Keterangan *</label><input type="text" class="form-control" required="" name="dokumen_note[]" class="form-control" placeholder="Berkas Ijazah"></div></div>').appendTo(scntDok);

			x++;
			return false;
		});

		$(document).on("click", ".remScnt_dokumen", function() {
			if (x > 2) {
