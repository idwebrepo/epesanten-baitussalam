...
<head>
	<title>Surat Izin Pulang <?php echo $pulang['student_full_name'] ?></title>
</head>
...
<body>
	...
	<table style="padding-top: -5px; padding-bottom: 5px">
		<tr>
			<td>
				<p class="name-school"><u><?php echo "SURAT PERIZINAN PULANG" ?></u></p>
			</td>
		</tr>
	</table>
	<table style="padding-top: -5px; padding-bottom: 5px">
		<tr>
			<td>
				<p class="detail">Yang bertanda tangan di bawah ini kami Pusat Keamanan pondok pesantren , menerangkan bahwa</p>
			</td>
		</tr>
	</table>
	<strong>
		<table style="padding-top: -5px; padding-bottom: 5px">
			<tbody>
				...
				<tr>
					<td style="width: 150px;">Kelas Pondok</td>
					<td style="width: 5px;">:</td>
					<td><?php echo ($pulang['madin_name'] == '' ? '-' : $pulang['madin_name']) ?></td>
				</tr>
			</tbody>
		</table>
	</strong>
	...
	<table>
		...
		<?php
		$user = $this->db->query("SELECT users.user_full_name AS petugas FROM users JOIN pulang ON pulang.pulang_user_id = users.user_id WHERE pulang.pulang_id = '" . $pulang['pulang_id'] . "'")->row_array();
		?>
	...
	<table>
		<tbody>
			...
			<tr>
				<td style="width: 100px;">2. Dewan Pengasuhan</td>
				<td style="width: 50px;">(………)</td>
			</tr>
		</tbody>
	</table>
