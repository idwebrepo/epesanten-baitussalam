...
if (isset($kredit)) {
	...
	$inputKasKode = set_value('accCode');
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<?php if (isset($kredit)) { ?>
							...
							<input type="hidden" name="kode_kas" value="<?php echo $inputKasKode ?>">
						<?php } ?>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="kredit_majors_id" value="<?php foreach ($majors as $row) {
																										echo ($inputMajorsValue == $row['majors_id']) ? $row['majors_short_name'] : '';
																									} ?>" placeholder="Unit Sekolah" readonly="">
