...
// User_customer view in list
  public function index($offset = NULL) {
    ...
    $data['satuan'] = $this->Ars_data_model->get_satuan($params);
    $data['setting_logo'] = $this->Setting_model->get(array('id' => 6));
    //$config['per_page'] = 10;
    //$config['uri_segment'] = 4;
    $config['base_url'] = site_url('manage/ars_satuan/index');
    ...
    $data['main'] = 'ars_satuan/ars_satuan_list';
...
// Add User_customer and Update
  public function add($id = NULL) {
    ...
    if ($_POST AND $this->form_validation->run() == TRUE) {
      ...
      if ($this->input->post('id_satuan')) {
        redirect('manage/ars_satuan/edit/' . $this->input->post('id_satuan'));
      }
      ...
      // $data['majors'] = $this->Student_model->get_majors();
      $data['title'] = $data['operation'] . ' Satuan Arsip';
      $data['main'] = 'ars_satuan/satuan_add';
      $this->load->view('manage/layout', $data);
    }
  }
...
// Delete to database
  public function delete($id = NULL) {
    ...
    if ($_POST) {
      ...
      redirect('manage/ars_satuan/edit/' . $id);
    }  
  }
}
