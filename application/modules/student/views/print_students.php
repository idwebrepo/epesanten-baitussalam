...
<html>
<head>
	<title><?php echo 'Data_Siswa_'.$majors['majors_short_name'].'_Kelas_'.$kelas['class_name'].'_Kelas Pondok_'.$madin['madin_name']; ?></title>
</head>
<body>
    <table style='border-bottom: 1px solid #000000; padding-bottom: 10px; width: 277mm;'>
		...
		<table style='width: 277mm;'>
			<tr>
				...
				<td style='width: 93mm; font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Data Siswa '.$majors['majors_short_name'].' Kelas '.$kelas['class_name'].' Kelas Pondok '.$madin['madin_name']; ?></b></td>
			...
			<tr>
    			...
    			?>
					<tr valign='top'>
						...
						<td style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo wordwrap($row['student_full_name'] , 15, "<br>\n") ?></td>
						<td align="center" style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo $row['student_gender'] ?></td>
						<td style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo wordwrap($row['student_address'] , 15, "<br>\n") ?></td>
						<td style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo wordwrap($row['student_name_of_father'] , 15, "<br>\n") ?></td>
						<td style='padding: 1px; font-size: 8pt; border: 1px solid #000000;'><?php echo wordwrap($row['student_name_of_mother'] , 15, "<br>\n") ?></td>
