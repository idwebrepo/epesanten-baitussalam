...
if (isset($student)) {
	...
	$inputKKValue = $student['student_kk'];
	...
	$inputMotherNIKValue = $student['mother_nik'];
	$inputFatherValue = $student['student_name_of_father'];
	$inputFatherNIKValue = $student['father_nik'];
	...
	$inputKKValue = set_value('student_kk');
	...
	$inputMotherNIKValue = set_value('mother_nik');
	$inputFatherValue = set_value('student_name_of_father');
	$inputFatherNIKValue = set_value('father_nik');
						...
						<div class="nav-tabs-custom">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1">
									...
									<div class="form-group">
										<label>NIK</label>
										<input name="student_nik" type="text" class="form-control" value="<?php echo $inputNIKValue ?>" placeholder="NIK Santri">
									</div>
									<div class="form-group">
										<label>No KK</label>
										<input name="student_kk" type="text" class="form-control" value="<?php echo $inputKKValue ?>" placeholder="No KK">
									</div>
									<div class="form-group">
								...
								<div class="tab-pane" id="tab_3">
									...
									<div class="form-group">
										<label>NIK Ibu</label>
										<input name="mother_nik" type="text" class="form-control" value="<?php echo $inputMotherNIKValue ?>" placeholder="NIK Ibu">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input name="father_nik" type="text" class="form-control" value="<?php echo $inputFatherNIKValue ?>" placeholder="Nama Ayah">
									</div>
									<div class="form-group">
