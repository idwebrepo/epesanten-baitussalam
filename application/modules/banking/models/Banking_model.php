...
class Banking_model extends CI_Model {
	...
	function get($params = array())
	{
		...
		if (isset($params['start']) && isset($params['end'])) {
    		$this->db->where('banking_date >=', $params['start']);
            $this->db->where('banking_date <=', $params['end']);
		}
		...
		if (isset($params['majors_id'])) {
			$this->db->where('majors.majors_id', $params['majors_id']);
		}
		...
		$this->db->select('student_nis, student_full_name, majors_short_name, class_name, banking_id, banking_date, banking_debit, banking_kredit, banking_code, banking_note');
	...
	function get_studnt($params = array())
	{
		if(isset($params['id']))
		{
			$this->db->where('banking_id', $params['id']);
