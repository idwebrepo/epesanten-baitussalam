...
<head>
	<title><?php foreach ($siswa as $row): ?> <?php echo  $row['student_full_name'] ?? '' ?><?php endforeach; ?></title>
</head>
...
<body>
	...
	<table style="padding-top: -5px; padding-bottom: 5px">
		<tbody>
			<tr>
				...
				<td style="width: 5px;">:</td>
				<td style="width: 131px;"><?php echo pretty_date($date, 'd F Y', false) ?></td>
			</tr>
			<tr>
	...
	<hr>
	<p class="detail">Dengan rincian transaksi tabungan sebagai berikut:</p>
