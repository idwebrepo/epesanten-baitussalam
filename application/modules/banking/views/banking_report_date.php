				...
				<div class="box box-success">
					<div class="box-header">
						...
						<div class="row">
							...
							<a class="btn btn-success" target="_blank" href="<?php echo site_url('manage/banking/banking_date_excel' . '/?' . http_build_query($q)) ?>"><i class="fa fa-file-excel-o" ></i> Excel</a>
							<?php } ?>
						    </div>
					        </div>
					</div>
