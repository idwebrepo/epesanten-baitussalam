			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<a href="<?php echo site_url('manage/ars_pengajuan/add') ?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah</a>
								...
								if (!empty($satuan)) {
									...
									foreach ($satuan as $row):
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('manage/ars_satuan/edit/' . $row['id_satuan']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
												
												<a href="#delModal<?php echo $row['id_satuan']; ?>" data-toggle="modal" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Hapus"></i></a>
											</td>	
										</tr>
										<div class="modal modal-default fade" id="delModal<?php echo $row['id_satuan']; ?>">
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<div class="modal-footer">
															<?php echo form_open('manage/ars_satuan/delete/' . $row['id_satuan']); ?>
															<input type="hidden" name="delName" value="<?php echo $row['nama_satuan']; ?>">
