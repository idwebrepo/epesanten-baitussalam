            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <p>Penginputan Limit Tabungan Santri bisa dilakukan dengan mengcopy data dari file Ms. Excel. Format file excel harus sesuai kebutuhan aplikasi. Silahkan download formatnya <a data-toggle="modal" data-target="#template_rfid"><span class="label label-success">Disini</span></a>
                            <br><br>
