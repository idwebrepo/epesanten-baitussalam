...
header("Content-Disposition: attachment; filename = Laporan-per-Jenis-Anggaran-" . $lap_title . "-per-Tanggal-" . pretty_date($ds, 'd/m/Y', FALSE) . "-Sampai-" . pretty_date($de, 'd/m/Y', FALSE) . ".xls");
...
<table style='width: 190mm;'>
	<tr>
		...
		<td colspan="6" style='font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Laporan per Jenis Anggaran (' . $lap_title . ') per Tanggal ' . pretty_date($ds, 'd F Y', FALSE) . ' Sampai ' . pretty_date($de, 'd F Y', FALSE) ?></b></td>
