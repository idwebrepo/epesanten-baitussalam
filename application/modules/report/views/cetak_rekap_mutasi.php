...
<head>
	<title><?php echo 'Rekap Laporan Mutasi Tanggal ' . pretty_date($ds, 'd-m-Y', FALSE) . ' Sampai ' . pretty_date($de, 'd-m-Y', FALSE) ?></title>
</head>
...
<body>
	...
	<table style='width: 190mm;'>
		<tr>
			...
			<td style='width: 150mm; font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Rekap Laporan Mutasi Tanggal ' . pretty_date($ds, 'd F Y', FALSE) . ' Sampai ' . pretty_date($de, 'd F Y', FALSE) ?></b></td>
