...
<head>
	<title><?php echo 'Laporan per Jenis Anggaran (' . $lap_title . ') per Tanggal ' . pretty_date($ds, 'd/m/Y', FALSE) . ' Sampai ' . pretty_date($de, 'd/m/Y', FALSE) ?></title>
...
<body>
	<table class="no-page-break" style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 190mm;'>
		<tr valign='top'>
	...
	<br>
	<table class="no-page-break" cellpadding='0' cellspacing='0' style='width: 190mm;'>
		<tr>
	...
	<br>
	<table class="no-page-break" style='width: 190mm;'>
		<tr>
			<td style='width: 20mm; font-size: 8pt; text-align: center' valign='center'></td>
			<td style='width: 150mm; font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Laporan per Jenis Anggaran Jurnal Umum (Kas & Bank) per Tanggal ' . pretty_date($ds, 'd F Y', FALSE) . ' Sampai ' . pretty_date($de, 'd F Y', FALSE) ?></b></td>
	...
	foreach ($bulan as $row) {
		...
		echo '<table class="no-page-break" cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                				...
                				<th align="center" style="font-size: 8pt; width: 30mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Kas</th>
		...
		foreach ($detailBulan as $res) {
			echo '<tr>
				                ...
				                <td style="padding: 1px; font-size: 8pt; text-align: left">' . $res['account_description'] . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">' . $res['month_name'] . '</td>
	...
	foreach ($free as $row) {
		...
		echo '<table class="no-page-break" cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                				...
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
                				<th align="center" style="font-size: 8pt; width: 30mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Kas</th>
                				<th align="center" style="font-size: 8pt; width: 10mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Keterangan</th>
                				<th align="center" style="font-size: 8pt; width: 15mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">NIS</th>
                				<th align="center" style="font-size: 8pt; width: 40mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Nama</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Kelas</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Penerimaan</th>
		...
		foreach ($detailFree as $res) {
			echo '<tr>
				                ...
				                <td style="padding: 1px; font-size: 8pt; text-align: left">' . $res['account_description'] . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">' . $res['bebas_pay_desc'] . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">' . $res['student_nis'] . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: left">' . $res['student_full_name'] . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">' . $res['class_name'] . '</td>
	...
	foreach ($debit as $row) {
		...
		foreach ($detailDebit as $res) {
			echo '<tr>
				                ...
				                <td style="padding: 1px; font-size: 8pt; text-align: left">' . wordwrap($res['debit_desc'], 30, "<br>\n") . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">' . '-' . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">' . '-' . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">' . '-' . '</td>
	...
	foreach ($kredit as $row) {
		...
		foreach ($detailKredit as $res) {
			echo '<tr>
				                ...
				                <td style="padding: 1px; font-size: 8pt; text-align: left">' . wordwrap($res['kredit_desc'], 30, "<br>\n") . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">' . '-' . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">' . '-' . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">' . '-' . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">' . '-' . '</td>
