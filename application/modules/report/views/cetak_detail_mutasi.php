...
<head>
	<title><?php echo 'Laporan Mutasi per Jenis Anggaran Tanggal ' . pretty_date($ds, 'd/m/Y', FALSE) . ' Sampai ' . pretty_date($de, 'd/m/Y', FALSE) ?></title>
</head>
...
<body>
	...
	<table style='width: 190mm;'>
		<tr>
			...
			<td style='width: 150mm; font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Laporan Mutasi per Jenis Anggaran Tanggal ' . pretty_date($ds, 'd F Y', FALSE) . ' Sampai ' . pretty_date($de, 'd F Y', FALSE) ?></b></td>
	...
	foreach ($bulan as $row) {
		...
		foreach ($detailBulan as $res) {
			echo '<tr>
				                ...
				                <td style="padding: 1px; font-size: 8pt; text-align: left">' . $res['akunKas'] . '</td>
