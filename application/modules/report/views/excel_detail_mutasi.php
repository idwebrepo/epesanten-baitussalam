...
header("Content-Disposition: attachment; filename = Laporan-Mutasi-per-Jenis-Anggaran-Tanggal " . pretty_date($ds, 'd-m-Y', FALSE) . " sampai " . pretty_date($de, 'd-m-Y', FALSE) . ".xls");
...
<table style='width: 190mm;'>
	<tr>
		...
		<td colspan="6" style='font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Laporan Muitas per Jenis Anggaran Tanggal ' . pretty_date($ds, 'd F Y', FALSE) . ' Sampai ' . pretty_date($de, 'd F Y', FALSE) ?></b></td>
...
foreach ($bulan as $row) {
	...
	echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                				...
                				<th align="center" style="font-size: 8pt; width: 35mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Kas</th>
                				<th align="center" style="font-size: 8pt; width: 10mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Bulan</th>
	...
	foreach ($detailBulan as $res) {
		echo '<tr>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . $no++ . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . pretty_date($res['bulan_date_pay'], 'd/m/Y', FALSE) . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . $res['akunKas'] . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: left">' . $res['month_name'] . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . $res['student_nis'] . '</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: left">' . $res['student_full_name'] . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . $res['class_name'] . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . 'Rp ' . number_format($res['bulan_bill'], 0, ",", ".") . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . '-' . '</td>
						    </tr>';
		$sumBln += $res['bulan_bill'];
	}
	echo '<tr style="background-color: #f0f0f0">
				                <td colspan="7" style="padding: 1px; font-size: 8pt; text-align: center"> <b>Total</b> </td>
...
foreach ($free as $row) {
	...
	foreach ($detailFree as $res) {
		echo '<tr>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . $no++ . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . pretty_date($res['bebas_pay_input_date'], 'd/m/Y', FALSE) . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . $res['akunKas'] . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: left">' . $res['bebas_pay_desc'] . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . $res['student_nis'] . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: left">' . $res['student_full_name'] . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . $res['class_name'] . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . 'Rp ' . number_format($res['bebas_pay_bill'], 0, ",", ".") . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . '-' . '</td>
						    </tr>';
...
foreach ($debit as $row) {
	...
	echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                				...
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
                				<th align="center" style="font-size: 8pt; width: 35mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Kas</th>
                				<th colspan="3" align="center" style="font-size: 8pt; width: 50mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Keterangan</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Penerimaan</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Pengeluaran</th>
                			</tr>';
	$sumDeb = 0;
	...
	foreach ($detailDebit as $res) {
		echo '<tr>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . $no++ . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . pretty_date($res['debit_date'], 'd/m/Y', FALSE) . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . $res['account_description'] . '</td>
				                <td colspan="3" style="padding: 1px; font-size: 8pt; text-align: left">' . $res['debit_desc'] . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . 'Rp ' . number_format($res['debit_value'], 0, ",", ".") . '</td>
				                <td style="vertical-align:top; padding: 1px; font-size: 8pt; text-align: center">' . '-' . '</td>
						    </tr>';
...
<table cellpadding='0' cellspacing='0' style='width: 190mm;'>
	...
	<tr>
		...
		<td style='font-size: 8pt; text-align: center'>:</td>
		<td style='font-size: 8pt; text-align: center'>Rp </td>
		<td style='font-size: 8pt; text-align: center'><?php echo number_format($saldoAwal['nominal'] + $sumA + ($sumLastA - $sumLastB), 0, ",", ".") ?></td>
		<td style='font-size: 8pt; text-align: center'>Rp </td>
		<td style='font-size: 8pt; text-align: center'><?php echo number_format($sumB, 0, ",", ".") ?></td>
	</tr>
	<tr>
