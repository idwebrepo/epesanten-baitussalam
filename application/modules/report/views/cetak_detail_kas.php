...
<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 190mm;'>
	    ...
	    echo '<b><font size="10px">Penerimaan</font></b> 
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailBulan = $this->Jurnal_model->get_bulan_tunai($ds, $de, $majors_id, $paramBulan, $kasBulan);
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailFree = $this->Jurnal_model->get_free_tunai($ds, $de, $majors_id, $paramFree, $kasFree);
                        echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                			    <th align="center" style="font-size: 8pt; width: 5mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">No.</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
	...
	<table cellpadding='0' cellspacing='0' style='width: 190mm;'>
		<!-- <tr>
			<td style='font-size: 8pt; text-align: '>
				sumBulan : <?php echo number_format($sumBulan, 0, ",", ".") ?><br>
				sumFree : <?php echo number_format($sumFree, 0, ",", ".") ?><br>
				sumDebit : <?php echo number_format($sumDebit, 0, ",", ".") ?><br>
				sumKredit : <?php echo number_format($sumKredit, 0, ",", ".") ?><br>
				sumGaji : <?php echo number_format($sumGaji, 0, ",", ".") ?><br><br>
			</td>
		</tr>
		<tr>
			<td style='font-size: 8pt; text-align: '>
				sumBulanLast : <?php echo number_format($sumBulanLast, 0, ",", ".") ?><br>
				sumFreeLast : <?php echo number_format($sumFreeLast, 0, ",", ".") ?><br>
				sumDebitLast : <?php echo number_format($sumDebitLast, 0, ",", ".") ?><br>
				sumKreditLast : <?php echo number_format($sumKreditLast, 0, ",", ".") ?><br>
				sumGajiLast : <?php echo number_format($sumGajiLast, 0, ",", ".") ?>
			</td>
		</tr> -->
	    <tr>
