									...
									foreach ($information as $row):
										...
										<tr>
											...
											<td>
												...
												<a href="<?php echo site_url('manage/pengumuman?i=' . $row['information_id']) ?>" class="btn btn-xs btn-success" data-toggle="tooltip" title="Broadcast" target="_blank"><i class="fa fa-whatsapp"></i></a>
											</td>	
										</tr>
