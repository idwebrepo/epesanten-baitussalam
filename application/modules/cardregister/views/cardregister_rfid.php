...
$filename = 'Template_Set_RFID_' . $majors['majors_short_name'] . '_Kelas_' . $kelas['class_name'];
...
<table cellpadding='0' cellspacing='0'>
    <tr>
        ...
        <th align='center' style='font-size: 8pt; width: 30mm; padding: 1px 0px 1px 0px; border: 1px solid #000000; background-color:#4188e0;'><b>No. RFID</b></th>
    <tr>
