				...
				<div class="box"> 
					<div class="box-header">
						...
						<table>
						    <tr>
								<td>
            						<a href="<?php echo site_url('manage/rekap_presensi/export_excel_bulan') ?>?tgl_awal=<?=$tgl_awal?>&tgl_akhir=<?=$tgl_akhir?>&majors_id=<?=$f['m']?>" class="btn btn-sm btn-danger" target="_blank"><i class="fa fa-file-excel-o"></i> Export Absensi (Perbulan)</a>
        					    </td>
								<td>&nbsp;</td>
        					    <td>
            						<a href="<?php echo site_url('manage/rekap_presensi/export_excel') ?>?tgl_awal=<?=$tgl_awal?>&tgl_akhir=<?=$tgl_akhir?>&majors_id=<?=$f['m']?>" class="btn btn-sm btn-info" target="_blank"><i class="fa fa-file-excel-o"></i> Export Rekap Perunit</a>
        					    </td>
								<td>&nbsp;</td>
								 <td>
            						<a href="<?php echo site_url('manage/rekap_presensi/rekap_kehadiran') ?>?tgl_awal=<?=$tgl_awal?>&tgl_akhir=<?=$tgl_akhir?>&majors_id=<?=$f['m']?>" class="btn btn-sm btn-warning" target="_blank"><i class="fa fa-file-excel-o"></i> Rekap Kehadiran kedatangan & kepulangan</a>
        					    </td> 
        					    <td>&nbsp;</td>
        					    <!-- <td>
            						<a href="<?php echo site_url('manage/rekap_presensi/rekapitulasi_presensi_excel') ?>?tgl_awal=<?=$tgl_awal?>&tgl_akhir=<?=$tgl_akhir?>&majors_id=<?=$f['m']?>" class="btn btn-sm btn-info" target="_blank"><i class="fa fa-file-excel-o"></i> Export Excel</a>
        					    </td>
								<td>&nbsp;</td> -->
        					    <!-- <td>
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<div class="modal-footer">
															<?php echo form_open('manage/rekap_presensi/delete/' . $row['id']); ?>
