...
class Kegiatan_pegawai extends CI_Controller {
...
// Nip
    ...
    $config['base_url'] = site_url('pegawai/kegiatan/index');
    ...
    $data['title'] = 'Kegiatan';
    $data['main'] = 'kegiatan/pegawai/kegiatan_list';
...
// Add User_customer and Update
  public function add($id = NULL) {
    ...
    if ($_POST AND $this->form_validation->run() == TRUE) {
      ...
      if ($this->input->post('kegiatan_id')) {
        redirect('pegawai/kegiatan/edit/' . $this->input->post('kegiatan_id'));
      }
...
// Edit mode
      ...
      $data['main'] = 'kegiatan/pegawai/kegiatan_add';
      $this->load->view('pegawai/layout', $data);
    }
  }
...
// Delete to database
  public function delete($id = NULL) {
    ...
    if ($_POST) {
      ...
      redirect('pegawai/kegiatan/edit/' . $id);
    }  
  }
}
