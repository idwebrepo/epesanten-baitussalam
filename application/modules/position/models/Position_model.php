...
class Position_model extends CI_Model
{
    ...
    function get($params = array())
    {
        ...
        $this->db->select("position_id, position_code, position_name, IF(`majors_short_name` IS NULL,'Lainnya',`majors_short_name`) as majors_short_name, `position_majors_id`, IF(`majors_id` IS NULL,'99',`majors_id`) as majors_id");
