		...
		<div class="row"> 
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title">Filter Data Tahfidz Siswa</h3>
						
						<a href="<?php echo site_url('manage/tahfidz/import_tahfidz') ?>" class="btn btn-sm btn-info"><i class="fa fa-upload"></i> Upload Tahfidz</a>
					</div><!-- /.box-header -->
					<div class="box-body">
			...
			<?php if ($f) { ?>
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Tahfidz Siswa</h3>
					</div><!-- /.box-header -->
					<div class="box-body">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tab_1" data-toggle="tab">Tambah Hafalan</a></li>
								<li><a href="#tab_2" data-toggle="tab">Laporan Tahfidz Siswa</a></li>
								<li><a href="#tab_3" data-toggle="tab">Rekap Laporan Tahfidz Siswa</a></li>
							</ul>
								...
								<div class="tab-pane active" id="tab_1">
                					...
                					<div class="row">
                						...
                						<div class="form-group">
                							...
                							<input type="number" class="form-control" required="" name="tahfidz_new" class="form-control" placeholder="Jumlah Surat">
                						</div>
                						</div>
                						...
                						<div class="form-group">
                							...
                							<input type="text" class="form-control" required="" name="tahfidz_new_note" class="form-control" placeholder="Keterangan Hafalan Baru">
                						</div>
                					    </div>
                						...
                						<div class="form-group">
                							...
                							<input type="text" class="form-control" required="" name="tahfidz_murojaah" class="form-control" placeholder="Murojaah Hafalan yang Sudah Dihafal Siswa">
                						</div>
                					    </div>
                						...
                						<div class="form-group">
                							...
                							<input type="text" class="form-control" required="" name="tahfidz_murojaah_note" class="form-control" placeholder="Murojaah Hafalan Baru (Sebelum Hafalan Hari Ini)">
                						</div>
                					    </div>
										...
										<table class="table table-bordered" style="white-space: nowrap;">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo $row['tahfidz_new'] . ' Surat' ?></td>
										...
										<table class="table table-bordered" style="white-space: nowrap;">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo $row['tahfidzSum'] . ' Surat' ?></td>
												</tr>
											<?php 
													$i++;
												endforeach; 
...
<script>
    function ambil_data(nis){
            ...
            window.location.href = '<?php echo base_url();?>manage/tahfidz?n='+thAjaran+'&r='+nisSiswa;
      }
