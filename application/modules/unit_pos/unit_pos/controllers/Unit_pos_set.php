...
class Unit_pos_set extends CI_Controller {
	...
	public function __construct() {
		...
		$this->load->model(array('payment/Payment_model', 'report/Detail_jurnal_model', 'setting/Setting_model', 'student/Student_model', 'period/Period_model', 'pos/Pos_model', 'item/Item_model', 'logs/Logs_model', 'unit_pos/Unit_pos_model', 'unit_pos/Unit_pos_detail_model'));
...
// 		//$sumDebitLast = $debitLast['debit_value'];
	...
	public function cetak_detail(){
		...
		$data['item_name'] = $list_item['pos_name'];
        
        $filename = 'Laporan Unit POS'. $item_name .' per Tanggal '.pretty_date($ds, 'd/m/Y', FALSE).' Sampai '.pretty_date($de, 'd/m/Y', FALSE).'.pdf';
        
        $this->load->view('unit_pos/cetak_detail_unit_pos',$data);
	...
	public function excel_detail(){
        ...
        $this->load->view('unit_pos/excel_detail_report',$data);
	}
	...
	public function cetak_rekap(){
        ...
        $filename = 'Rekap Laporan POS'.$item_name.' per Tanggal '.pretty_date($ds, 'd/m/Y', FALSE).' Sampai '.pretty_date($de, 'd/m/Y', FALSE).'.pdf';
        
        $this->load->view('unit_pos/cetak_rekap_report',$data);
	...
	public function excel_rekap(){
        ...
        $this->load->view('unit_pos/excel_rekap_report',$data);
	}
