...
<html>
<head>
	<title><?php echo 'Rekap Laporan per Unit POS ' . $item_name . ' per Tanggal '.pretty_date($ds, 'd/m/Y', FALSE).' Sampai '.pretty_date($de, 'd/m/Y', FALSE) ?></title>
</head>
<body>
    <table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 190mm;'>
		...
		<table style='width: 190mm;'>
			<tr>
				...
				<td style='width: 150mm; font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Rekap Laporan per Unit POS '.$item_name.' per Tanggal '.pretty_date($ds, 'd F Y', FALSE).' Sampai '.pretty_date($de, 'd F Y', FALSE) ?></b></td>
				<td style='width: 20mm; font-size: 8pt;' align='right'></td>
			</tr>
			<tr>
			    <td style='width: 20mm; font-size: 8pt; text-align: center' valign='center'></td>
				<td style='width: 150mm; font-size: 8pt; text-align: center' valign='top' align='center'></td>
				<td style='width: 20mm; font-size: 8pt;' align='right'></td>
			</tr>
		</table>
		<br>
