...
<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 190mm;'>
	...
	<table style='width: 190mm;'>
		<tr>
			...
			<td colspan='5' style='font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Rekap Laporan per Unit POS ' . $item_name . ' per Tanggal '.pretty_date($ds, 'd F Y', FALSE).' Sampai '.pretty_date($de, 'd F Y', FALSE) ?></b></td>
		...
		<tr>
			...
			<td colspan='5' style='width: 150mm; font-size: 8pt; text-align: center' valign='top' align='center'></td>
