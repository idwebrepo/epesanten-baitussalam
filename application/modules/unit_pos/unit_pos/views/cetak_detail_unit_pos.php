...
<html>
<head>
	<title><?php echo 'Laporan Unit per Unit POS '.$item_name.' per Tanggal '.pretty_date($ds, 'd/m/Y', FALSE).' Sampai '.pretty_date($de, 'd/m/Y', FALSE) ?></title>
</head>
<body>
<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 190mm;'>
		...
		<table style='width: 190mm;'>
			<tr>
				...
				<td style='width: 150mm; font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Laporan per Unit POS ' . $item_name . ' per Tanggal '.pretty_date($ds, 'd F Y', FALSE).' Sampai '.pretty_date($de, 'd F Y', FALSE) ?></b></td>
	    ...
	    echo '<b><font size="10px">Penerimaan</font></b> 
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailBulan = $this->Unit_pos_detail_model->get_bulan($ds, $de, $item_id, $majors_id, $paramBulan, $kasBulan);
                    echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
				        ...
				        echo '<tr>
				                ...
				                <td style="padding: 1px; font-size: 8pt; text-align: left">'.wordwrap($res['student_full_name'],15,"<br>\n").'</td>
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailFree = $this->Unit_pos_detail_model->get_free($ds, $de, $item_id, $majors_id, $paramFree, $kasFree);
                        echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                			    <th align="center" style="font-size: 8pt; width: 5mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">No.</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
                				...
                				<th align="center" style="font-size: 8pt; width: 15mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">NIS</th>
                				<th align="center" style="font-size: 8pt; width: 35mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Nama</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Kelas</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Penerimaan</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Pengeluaran</th>
                			</tr>';
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailDebit = $this->Unit_pos_detail_model->get_debit($ds, $de, $item_id, $majors_id, $paramDebit, $kasDebit);
                        echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                				<th align="center" style="font-size: 8pt; width: 5mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">No.</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
	    ...
	    echo '<b><font size="10px">Pengeluaran</font></b>
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailKredit = $this->Unit_pos_detail_model->get_kredit($ds, $de, $item_id, $majors_id, $paramKredit, $kasKredit);
                        echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                			    <th align="center" style="font-size: 8pt; width: 5mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">No.</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
				        ...
				        echo '<tr>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">'.$no++.'</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">test'.pretty_date($res['kredit_date'], 'd/m/Y', FALSE).'</td>
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailGaji = $this->Unit_pos_detail_model->get_gaji($ds, $de, $item_id, $majors_id, $paramGaji, $kasGaji);
                        echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                			    <th align="center" style="font-size: 8pt; width: 5mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">No.</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
	...
	<?php
		...
		// echo 'sumbulanlast : '.$sumBulanLast.'<br>';
		// echo 'sumFreeLast : '.$sumFreeLast.'<br>';
		// echo 'sumDebitLast : '.$sumDebitLast.'<br>';
		// echo 'sumKreditLast : '.$sumKreditLast.'<br>';
		// echo 'sumGajiLast : '.$sumGajiLast.'<br>';
	?>
	<table cellpadding='0' cellspacing='0' style='width: 190mm;'>
	    <tr>
