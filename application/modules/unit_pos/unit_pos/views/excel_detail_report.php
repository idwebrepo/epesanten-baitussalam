<?php 
    ...
    header("Content-Disposition: attachment; filename = Laporan-per-Unit-POS-".$item_name."-per-Tanggal-".pretty_date($ds, 'd/m/Y', FALSE)."-Sampai-".pretty_date($de, 'd/m/Y', FALSE).".xls");
...
<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 190mm;'>
	...
	<table style='width: 190mm;'>
		<tr>
			...
			<td colspan="6" style='font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Laporan per Unit POS '.$item_name.' per Tanggal '.pretty_date($ds, 'd F Y', FALSE).' Sampai '.pretty_date($de, 'd F Y', FALSE) ?></b></td>
			<td colspan="1" style='font-size: 8pt;' align='right'></td>
		</tr>
		<tr>
		    <td colspan="1" style='font-size: 8pt; text-align: center' valign='center'></td>
			<td colspan="6" style='font-size: 8pt; text-align: center' valign='top' align='center'></td>
			<td colspan="1" style='font-size: 8pt;' align='right'></td>
		</tr>
	</table>
	<br>
	    ...
	    echo '<b><font size="10px">Pengeluaran</font></b>
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailGaji = $this->Unit_pos_detail_model->get_kredit($ds, $de, $item_id, $majors_id, $paramGaji, $kasGaji);
                        echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                			    <th align="center" style="font-size: 8pt; width: 5mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">No.</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
